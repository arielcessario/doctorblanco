...
export class VirtualScrollComponent implements OnInit, OnDestroy, OnChanges {
    ...
    constructor(private element: ElementRef, private renderer: Renderer2, private coreService: CoreService) {
    }
    ...
    ngOnInit() {
        ...
        this.coreService.getProductos.subscribe(()=> {
            this.element.nativeElement.scrollTop = this.element.nativeElement.scrollTop + 1;
            this.element.nativeElement.scrollTop = this.element.nativeElement.scrollTop - 1;
            this.calculateItems();
        });
    }
